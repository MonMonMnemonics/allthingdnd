                            ...
                            {   (editMode) ? null
                                : <Fragment>
                                    ...
                                    <div className="flex flex-col items-center w-full">
                                        ...
                                        <div className="text-sm">*You'll only need this password if you want to edit your answer later.</div>
                                    </div>
                                    <hr className="h-px my-2 bg-white border-0"/>
                                </Fragment>
                            }
                                        ...
                                        if (editMode) {
                                            ...
                                            if ((data.pass ?? "") != "") {                                                
                                                ...
                                                Swal.fire({
                                                    ...
                                                    text: "Are you sure you want to leave password empty? You won't be able to edit your answer later.",
                                                    icon: "warning",
                                                    theme: "dark",
